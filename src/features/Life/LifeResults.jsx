  ...
  return (
    <div className="p-8 md:p-14 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="text-center mb-12">
        <h2 className="text-5xl font-black text-[#002855] mb-2">Your Personalized Quote</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-br from-[#002855] via-[#003d7a] to-[#002855] text-white rounded-3xl p-10 shadow-2xl border border-[#0ea5e9]/20 flex flex-col justify-between">
          <div>
            <p className="text-[11px] font-black uppercase tracking-widest text-[#0ea5e9] mb-4">Monthly Premium</p>
          ...
          <button 
            onClick={onNext}
            className="w-full bg-[#0ea5e9] hover:bg-[#06b6d4] text-[#002855] font-black py-5 rounded-2xl shadow-lg transition-all transform hover:scale-105 flex items-center justify-center gap-3 uppercase tracking-widest"
          >
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-all">
            <div className="flex items-center gap-2 mb-4">
              <DollarSign className="text-[#0ea5e9]" size={22} />
              <h3 className="font-black text-[#002855] text-lg">Coverage Amount</h3>
            </div>
            <div className="flex justify-between items-center mb-4">
              <span className="text-slate-600 font-semibold">Current:</span>
              <span className="text-2xl font-black text-[#002855]">${(formData.coverage / 1000).toLocaleString(undefined, { maximumFractionDigits: 0 })}k</span>
            </div>
            <input 
              type="range" 
              min="100000" 
              ...
              className="w-full h-3 bg-gradient-to-r from-slate-200 to-[#0ea5e9] rounded-lg appearance-none cursor-pointer accent-[#0ea5e9] shadow-md"
            />
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-all">
            <div className="flex items-center gap-2 mb-6">
              <Calendar className="text-[#0ea5e9]" size={22} />
              <h3 className="font-black text-[#002855] text-lg">Policy Term</h3>
            </div>
              ...
              {[10, 15, 20, 30].map((yr) => (
                <button 
                  ...
                  className={`py-4 px-2 border-2 rounded-xl font-black transition-all text-sm ${
                    formData.years === yr 
                    ? 'border-[#002855] bg-[#002855] text-white shadow-lg shadow-blue-500/30' 
                    : 'border-slate-200 text-slate-600 bg-white hover:border-[#0ea5e9] hover:bg-slate-50'
                  }`}
                >
                  {yr}yr
                </button>
      ...
      <div className="mt-12 pt-8 border-t-2 border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
        <button 
          onClick={onPrev}
          className="text-[#002855] font-black hover:text-[#0ea5e9] flex items-center gap-2 transition-colors text-lg"
        >
          <ChevronLeft size={20} /> Back to Edit
        </button>
        <div className="flex flex-col md:flex-row gap-6 text-center">
          <div className="flex items-center gap-2 text-sm font-bold text-slate-600">
            <Zap className="text-[#0ea5e9]" size={18} /> Instant Quote
          </div>
          <div className="flex items-center gap-2 text-sm font-bold text-slate-600">
